...
\begin{figure}
\centering
\includegraphics[scale=.9]{Figures/LPdiagram.pdf}
...
The time-to-death T distribution of a closed birth cohort C reveals its life table. Conversely, the distribution of birth cohorts of people of a given thanatological age reveals mortality history and inequalities in survival. 

[placeholder for CT diagram]

A lifeline on the CT plane extends from 0 upward until the age of death. Ergo, someone born in 1700 dying at age 80 contributes 1 to the count in each time step descending from 80 to 0, the entire countdown. T = 0 is maximally heterogenous with respect to A (or L or D or P), and lifeline overlap decreases in higher T (long-lived people while they're young, i.e. in years closer to C itself). Here's that tabulation of this same data (also logged):
