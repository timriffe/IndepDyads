...
\begin{subfigure}[t]{0.45\linewidth}
    ...
    \caption{The four view axes of the triad dependencies map to the medians of the tetrahedron. The APC view axis is depicted with a dashed line. TPD, CDL, or TAL would be other possibilities.}
...
\begin{subfigure}[t]{0.45\linewidth}
    ...
    \caption{The three view axes of the independent planes map to the bimedians of the tetrahedron. The LP view axis is depicted with a dashed line connecting the midpoints of edges $l$ and $p$. The LP plane is orthogonal to this line, here shown in translucent red intersecting at the origin. AD or TC would be other possibilities.}
    \label{fig:indepviewaxes}       
\end{subfigure}
\caption{The seven view axes of the demographic time identity map to geometric properties of the regular tetrahedron, here drawn as a perspective plot. Triad planes are seen by gazing orthogonal to a face of the tetrahedron. The independent dyad planes are seen by aligning opposite edges at their midpoints }
\label{fig:viewaxes}
\end{figure}
