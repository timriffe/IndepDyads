...
\begin{subfigure}[t]{0.45\linewidth}
    ...
    \caption{(placeholder diagram) The four view axes of the triad dependencies map to the medians of the tetrahedron.}
...
\begin{subfigure}[t]{0.45\linewidth}
    ...
    \caption{(Placeholder diagram) The three view axes of the independent planes map to the bimedians of the tetrahedron.}
