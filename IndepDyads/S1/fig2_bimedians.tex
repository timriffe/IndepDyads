...
% bimedian lines: pick one
 \draw[->,color={rgb:red,1;green,1;blue,1}, line width = {0.2pt}] (1.3*-0.16666665,1.3*-0.54170805,1.3*0.11003605) -- (1.3*0.16666665,1.3*0.54170805,1.3*-0.11003605); % $LP$ bimedian
...
% bimed plane
\fill[-, fill={rgb:red,1;green,0;blue,0}, opacity=.08] (0.728308080163917,-0.269597346614407,-0.224093606333948)--(0.26164141349725,0.0741165522707336,0.761172674730244)--(-0.728308080163917,0.269597346614407,0.224093606333948)--(-0.26164141349725,-0.0741165522707337,-0.761172674730244)--cycle; 

 % bimed intersection plane
\draw[-, color={rgb:red,1;green,1;blue,1}, opacity=.5, line width = {0.1pt}] (0.52022005725994,-0.192569533296005,-0.160066861667106)--(0.186886723926607,0.0529403944790955,0.54369476766446)--(-0.52022005725994,0.192569533296005,0.160066861667106)--(-0.186886723926607,-0.0529403944790954,-0.54369476766446)--cycle;
...
\node[right, color={rgb:red,49;green,145;blue,201}] at (0.16666665,0.54170805,-0.11003605) {\tiny $p$};      % AB mean
...
\node[below left, color={rgb:red,197;green,117;blue,43}] at (-0.16666665,-0.54170805,0.11003605) {\tiny$l$};       % CD mean
...
% C midpoint
\node[mark size=.3pt,color={rgb:red,210;green,188;blue,45}] at (0.52022005,-0.19256955,-0.16006685) {\pgfuseplotmark{*}}; 
 % D midpoint
\node[mark size=.3pt,color={rgb:red,136;green,31;blue,147}] at (0.1868867,0.0529404,0.5436948) {\pgfuseplotmark{*}}; 
% T midpoint
\node[mark size=.3pt,color={rgb:red,78;green,201;blue,59}] at (-0.52022005,0.19256955,0.16006685) {\pgfuseplotmark{*}}; 
% L midpoint
\node[mark size=.5pt,color={rgb:red,197;green,117;blue,43}] at (-0.16666665,-0.54170805,0.11003605) {\pgfuseplotmark{*}}; 
% A midpoint
\node[mark size=.3pt,color={rgb:red,210;green,55;blue,55}] at (-0.1868867,-0.0529404,-0.5436948) {\pgfuseplotmark{*}}; 
